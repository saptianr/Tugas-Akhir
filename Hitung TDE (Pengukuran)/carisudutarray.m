...
for i=1:100;
    ...
    name1=sprintf('Track 1_%03d.wav',i);%Sinyal yang ditangkap hidrophone 1
    name2=sprintf('Track 2_%03d.wav',i);%Sinyal yang ditangkap hidrophone 2
    name3=sprintf('Track 3_%03d.wav',i);%Sinyal yang ditangkap hidrophone 3
    name4=sprintf('Track 4_%03d.wav',i);%Sinyal yang ditangkap hidrophone 4
